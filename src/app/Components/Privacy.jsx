...
export const metadata = {
    title: 'Privacy Policy | Digitallink saudi',
...
export const jsonLd = {
    ...
    isPartOf: {
        '@type': 'WebSite',
        name: 'Digitallink saudi',
        url: 'https://digitallink-sa.com' // Replace with your actual website URL
    },
    breadcrumb: {
        '@type': 'BreadcrumbList',
        itemListElement: [{
            ...
            position: 2,
            name: 'Privacy Policy',
            item: 'https://digitallink-sa.com/privacy'
        }]
    }
};
